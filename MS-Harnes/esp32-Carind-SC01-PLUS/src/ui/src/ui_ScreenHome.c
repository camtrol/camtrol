...
void ui_ScreenHome_screen_init(void)
{
    ...
    ui_ImageSleep = lv_img_create(ui_Container1);
    ...
    lv_obj_set_x(ui_ImageSleep, -113);
    lv_obj_set_y(ui_ImageSleep, -1);
    lv_obj_set_align(ui_ImageSleep, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImageSleep, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    ...
    lv_obj_set_x(ui_ImageNetwork, 181);
    ...
    lv_img_set_zoom(ui_ImageNetwork, 150);
    ...
    lv_obj_set_width(ui_Label27, 59);
    lv_obj_set_height(ui_Label27, 20);
    lv_obj_set_x(ui_Label27, -166);
    lv_obj_set_y(ui_Label27, -141);
    ...
    lv_obj_set_style_text_font(ui_Label27, &ui_font_SOYOMapleBold14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelPWM, -210);
    lv_obj_set_y(ui_LabelPWM, -107);
    lv_obj_set_align(ui_LabelPWM, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LabelPWM, "0");
    lv_obj_add_flag(ui_LabelPWM, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ...
    lv_obj_set_style_text_font(ui_LabelPWM, &ui_font_SOYOMapleBold14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_PanelLED, 408);
    lv_obj_set_height(ui_PanelLED, 280);
    lv_obj_set_x(ui_PanelLED, -28);
    lv_obj_set_y(ui_PanelLED, 17);
    ...
    lv_label_set_text(ui_Label3, "트렁크");
    ...
    lv_obj_set_height(ui_Button4, 75);
    ...
    lv_img_set_zoom(ui_Image11, 130);
    ...
    lv_label_set_text(ui_Label4, "어닝등");
    ...
    lv_obj_set_height(ui_Button5, 75);
    ...
    lv_label_set_text(ui_Label5, "물펌프");
    ...
    lv_obj_set_width(ui_Button6, 85);
    ...
    lv_label_set_text(ui_Label6, "시거잭");
    ...
    lv_obj_set_width(ui_Button7, 85);
    ...
    lv_label_set_text(ui_Label7, "냉장고");
    ...
    lv_obj_set_width(ui_Button8, 85);
    lv_obj_set_height(ui_Button8, 75);
    ...
    lv_obj_set_style_outline_pad(ui_Slider3, 6, LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelBright2, 210);
    lv_obj_set_y(ui_LabelBright2, 146);
    ...
    lv_obj_set_style_text_font(ui_LabelBright2, &ui_font_SOYOMapleBold14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelBright, 210);
    ...
    ui_ImageWiFi = lv_img_create(ui_ScreenHome);
    ...
    lv_obj_set_x(ui_ImageWiFi, 217);
    lv_obj_set_y(ui_ImageWiFi, -145);
    ...
    lv_img_set_zoom(ui_ImageWiFi, 150);

    ui_ContainerSleep = lv_obj_create(ui_ScreenHome);
    lv_obj_remove_style_all(ui_ContainerSleep);
    lv_obj_set_width(ui_ContainerSleep, 46);
    lv_obj_set_height(ui_ContainerSleep, 36);
    lv_obj_set_x(ui_ContainerSleep, -113);
    lv_obj_set_y(ui_ContainerSleep, -143);
