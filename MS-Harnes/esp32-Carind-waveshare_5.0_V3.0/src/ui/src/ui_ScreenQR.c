...
void ui_ScreenQR_screen_init(void)
{
    ...
    lv_obj_set_width(ui_LabelSSID, 250);
    ...
    lv_label_set_text(ui_LabelSSID, "카인드 V3.0-CD-070");
    ...
    lv_obj_set_width(ui_LabelPSWD, 250);
    ...
    lv_label_set_text(ui_LabelPSWD, "18250228070");
    lv_obj_clear_flag(ui_LabelPSWD, LV_OBJ_FLAG_SCROLL_CHAIN);      /// Flags
    ...
    lv_img_set_src(ui_ImageQR, &ui_img_1808593792);
