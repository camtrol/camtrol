...
void ui_ScreenHome_screen_init(void)
{
    ...
    lv_obj_set_x(ui_ImageSleep, -158);
    lv_obj_set_y(ui_ImageSleep, 0);
    ...
    lv_obj_set_style_text_font(ui_LabelAmPm, &ui_font_SOYOMapleBold18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_PanelLED, 660);
    lv_obj_set_height(ui_PanelLED, 410);
    lv_obj_set_x(ui_PanelLED, -56);
    ...
    lv_obj_set_x(ui_LabelBright2, 340);
    ...
    lv_obj_set_x(ui_LabelBright, 340);
    ...
    lv_obj_set_x(ui_Container3, 24);
    lv_obj_set_y(ui_Container3, -214);
    ...
    lv_obj_set_height(ui_Container4, 482);
