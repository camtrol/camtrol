...
#define RTC_YEAR_ADDR                                                          \
  (0x0A) // years 0-99; calculate real year = 1970 + RCC reg year
...
#define RTC_CTRL_1_CIE                                                         \
  (0X04) // 0-no correction interrupt generated 1-interrupt pulses are generated
         // at every correction cycle
...
#define RTC_CTRL_2_AF (0X40)  // alarm flag  0-inactive/cleared
                              // 1-active/unchanged
...
#define RTC_TIMER_MODE_TI_TP                                                   \
  (0X01) // timer interrupt mode 0-interrupt follows timer flag 1-interrupt
         // generates a pulse
