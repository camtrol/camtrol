...
void ui_ScreenQR_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_ScreenQR, lv_color_hex(0x3A3A3A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Label23, 350);
    lv_obj_set_y(ui_Label23, -66);
    ...
    lv_obj_set_height(ui_LabelSSID, 45);
    lv_obj_set_x(ui_LabelSSID, 160);
    lv_obj_set_y(ui_LabelSSID, -22);
    lv_obj_set_align(ui_LabelSSID, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LabelSSID, "카인드 V3.0-SD-065");
    ...
    lv_obj_set_height(ui_LabelPSWD, 45);
    lv_obj_set_x(ui_LabelPSWD, 160);
    lv_obj_set_y(ui_LabelPSWD, 85);
    lv_obj_set_align(ui_LabelPSWD, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LabelPSWD, "18250228065");
    ...
    lv_obj_set_x(ui_Label24, 350);
    lv_obj_set_y(ui_Label24, 42);
    ...
    lv_img_set_src(ui_ImageQR, &ui_img_1889667102);
    ...
    lv_obj_set_x(ui_Slider2, -202);
    lv_obj_set_y(ui_Slider2, 167);
    ...
    lv_label_set_text(ui_Label37, "슬레이브");
    ...
    lv_obj_set_x(ui_Label39, -145);
    lv_obj_set_y(ui_Label39, -150);
    lv_obj_set_align(ui_Label39, LV_ALIGN_RIGHT_MID);
    lv_label_set_text(ui_Label39, "마스타");
    ...
    lv_obj_set_x(ui_LabelBtnInit, 160);
    lv_obj_set_y(ui_LabelBtnInit, -106);
    ...
    lv_obj_set_style_text_font(ui_LabelBtnInit, &ui_font_SOYOMapleBold18, LV_PART_MAIN | LV_STATE_DEFAULT);
