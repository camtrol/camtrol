...
void ui_ScreenHome_screen_init(void)
{
    ...
    lv_img_set_src(ui_Image1, &ui_img_campingcar_icons_png);
    lv_obj_set_width(ui_Image1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Image1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Image1, -220);
    lv_obj_set_y(ui_Image1, -145);
    lv_obj_set_align(ui_Image1, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_Image1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_img_set_zoom(ui_Image1, 260);

    ui_Label27 = lv_label_create(ui_ScreenHome);
    lv_obj_set_width(ui_Label27, 100);
    lv_obj_set_height(ui_Label27, 20);
    lv_obj_set_x(ui_Label27, -152);
    lv_obj_set_y(ui_Label27, -144);
    lv_obj_set_align(ui_Label27, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label27, "마레캠핑카");
    ...
    lv_obj_set_y(ui_LabelTemp, 33);
    lv_obj_set_align(ui_LabelTemp, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LabelTemp, "0.0 도");
    lv_obj_set_style_text_font(ui_LabelTemp, &ui_font_SOYOMapleBold14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Image5 = lv_img_create(ui_PanelDisplay);
    lv_img_set_src(ui_Image5, &ui_img_1276658041);
    ...
    lv_obj_set_style_text_font(ui_LabelHumi, &ui_font_SOYOMapleBold14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label1, "팝업등");
    ...
    lv_label_set_text(ui_Label2, "침상등");
    ...
    lv_label_set_text(ui_Label4, "전면등");
    ...
    lv_img_set_src(ui_Image10, &ui_img_1965946780);
    ...
    lv_label_set_text(ui_Label5, "후면등");
    ...
    lv_label_set_text(ui_Label6, "철재장");
    ...
    lv_label_set_text(ui_Label7, "무드등");
    ...
    lv_img_set_src(ui_Image14, &ui_img_2022945322);
    ...
    lv_label_set_text(ui_Label9, "전체등");
    ...
    lv_img_set_src(ui_Image15, &ui_img_1294863193);
    ...
    lv_label_set_text(ui_Label20, "인버터");
    ...
    lv_img_set_src(ui_Image16, &ui_img_1247291337);
    ...
    lv_img_set_src(ui_Image17, &ui_img_941216143);
    ...
    lv_label_set_text(ui_Label22, "냉장고");
    ...
    lv_obj_set_height(ui_Slider3, 280);
    lv_obj_set_x(ui_Slider3, -198);
    lv_obj_set_y(ui_Slider3, 17);
    ...
    ui_Image19 = lv_img_create(ui_ContainerLock);
    lv_img_set_src(ui_Image19, &ui_img_460647138);
    lv_obj_set_width(ui_Image19, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Image19, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Image19, -135);
    lv_obj_set_y(ui_Image19, 15);
    ...
    lv_label_set_text(ui_LabelDay, "20년 12월 25일 토요일");
