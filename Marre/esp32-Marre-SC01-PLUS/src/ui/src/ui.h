...
#ifndef _SQL_MARRE_SC01_PLUS_UI_H
#define _SQL_MARRE_SC01_PLUS_UI_H
...
LV_IMG_DECLARE(ui_img_1669298272);    // assets/Icon-25.png
LV_IMG_DECLARE(ui_img_logo_png);    // assets/Logo.png
LV_IMG_DECLARE(ui_img_min_png);    // assets/Min.png
LV_IMG_DECLARE(ui_img_1719754239);    // assets/QR-Code-051.png
LV_IMG_DECLARE(ui_img_1847130928);    // assets/QR-Code-052.png
LV_IMG_DECLARE(ui_img_1366107189);    // assets/QR-Code-053.png
LV_IMG_DECLARE(ui_img_316327430);    // assets/QR-Code-054.png
LV_IMG_DECLARE(ui_img_765401749);    // assets/QR-Code-055.png
LV_IMG_DECLARE(ui_img_sec_png);    // assets/Sec.png
