...
void ui_ScreenHome_screen_init(void)
{
    ...
    lv_label_set_text(ui_LabelBGBright, "100");
    ...
    lv_obj_set_style_bg_color(ui_Button6, lv_color_hex(0x797979), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_Image16 = lv_img_create(ui_Button6);
    ...
    lv_obj_set_height(ui_PanelMessage, 292);
    lv_obj_set_x(ui_PanelMessage, 0);
    lv_obj_set_y(ui_PanelMessage, 26);
    ...
    lv_obj_set_style_bg_color(ui_PanelMessage, lv_color_hex(0x313131), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_PanelMessage, 230, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_LabelMessage,
                      "저 전압 보호모드로 진입 하였습니다.\n\n모든 출력을 차단 합니다.");
    ...
    lv_obj_set_style_text_font(ui_LabelMessage, &ui_font_SOYOMapleBold26, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Button11 = lv_btn_create(ui_PanelMessage);
    lv_obj_set_width(ui_Button11, 100);
    lv_obj_set_height(ui_Button11, 60);
    lv_obj_set_align(ui_Button11, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_Button11, LV_OBJ_FLAG_HIDDEN);     /// Flags

    ui_Label10 = lv_label_create(ui_Button11);
